...
#   cd ~/ && rm -f install-in-termux.sh && wget -q https://raw.githubusercontent.com/BLBMS/am/moje/install-in-termux.sh && chmod +x install-in-termux.sh && ./install-in-termux.sh
...
echo -e "\n\e[93m■■■ zaganjam UBUNTU ■■■\e[0m\n"
echo "alias u=./start-ubuntu.sh"
sleep 1
./start-ubuntu.sh
